...
function AI4() {
    ...
    try {
      const response = await fetch('https://api.openai.com/v1/chat/completions', {
        ...
        body: JSON.stringify({
          model: 'gpt-4',
          messages: [
            { role: 'system', content: `You are a helpful assistant that translates text from ${fromLanguage} to ${targetLanguage}. Do not return anything else other than the translated text.` },
  ...
  return (
    <Container className="AI" style={{ paddingTop: '20px' }}>
      <Card>
        <Card.Body>
          <Card.Title className="text-center">Speech-to-Text and Translation</Card.Title>
          ...
          <Row className="mb-3">
            <Col>
              <Form.Group>
                ...
                <Form.Control as="select" value={fromLanguage} onChange={handleFromLanguageChange}>
                  {languages.map((lang) => (
          ...
          <Row className="mb-3">
            <Col>
              ...
              <Form.Control as="textarea" rows="4" value={translatedText} readOnly />
            </Col>
          </Row>
